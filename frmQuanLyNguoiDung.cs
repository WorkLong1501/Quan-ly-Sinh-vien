...
namespace CNQuanLySV
{
    public partial class frmQuanLyNguoiDung : Form
    {
        ...
        private void btnThemmoi_Click(object sender, EventArgs e)
        {
            ...
            string select2 = "Select * From LOGIN where TenDN='" + txtTaikhoan.Text + "'";
            ...
            else
            {
                ...
                reader2.Dispose();
                // Thực hiện truy vấn
                string insert = "Insert Into LOGIN(TenDN,MatKhau,HoTen,Gioitinh,Phone,Email,Quyen)" +
                                "Values('" + txtTaikhoan.Text + "','" + txtMK.Text + "',N'" + txtHoTen.Text + "',N'" + cboGioiTinh.Text + "','" +
                                txtPhone.Text + "','" + txtEmail.Text + "',N'" + cboQuyen.Text + "')";
        ...
        private void dgrLogin_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtPhone.Text = dgrLogin.CurrentRow.Cells[4].Value.ToString();
        ...
        private void frmQuanLyNguoiDung_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'dataQLSV1.LOGIN' table. You can move, or remove it, as needed.
            this.lOGINTableAdapter1.Fill(this.dataQLSV1.LOGIN);
            conn = cc.Connected();
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                SqlCommand cmd = new SqlCommand("delete from LOGIN where TenDN='" + txtTaikhoan.Text + "'", conn);
                cmd.ExecuteNonQuery();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                // Thực hiện truy vấn
                string update = "Update LOGIN Set MatKhau=N'" + txtMK.Text + "',HoTen=N'" + txtHoTen.Text + "',GioiTinh=N'" +
                                cboGioiTinh.Text + "',Phone=N'" + txtPhone.Text + "',Email=N'" +
                                txtEmail.Text + "',Quyen=N'" + cboQuyen.Text + "' where TenDN=N'" + txtTaikhoan.Text + "'";
