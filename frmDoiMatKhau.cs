...
namespace CNQuanLySV
{
    public partial class frmDoiMatKhau : Form
    {
        ...
        {
            string select2 = "Select * From LOGIN where TenDN='" + txtTaikhoan.Text + "' and MatKhau='" + txtMKcu.Text + "'";
            ...
            else if (reader2.Read())
            {
                ...
                reader2.Dispose();
                // Thực hiện truy vấn
                string update = "Update LOGIN Set MatKhau='" + txtMKmoi.Text + "' where TenDN='" + txtTaikhoan.Text + "'";
